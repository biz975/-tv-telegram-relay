...
SYMBOLS = [
    ...
    "TON/USDT","DOGE/USDT","AVAX/USDT","TRX/USDT","DOT/USDT",
    "LINK/USDT","NEAR/USDT","ATOM/USDT","APT/USDT","BCH/USDT",
    "LTC/USDT","FIL/USDT","INJ/USDT","SUI/USDT","OP/USDT","ARB/USDT",
    "ICP/USDT","LDO/USDT","AAVE/USDT","RNDR/USDT","FTM/USDT","TIA/USDT","SEI/USDT","TAO/USDT" , "ETC/USDT",
    "ALGO/USDT","GRT/USDT","KAS/USDT","FLOW/USDT","SAND/USDT",
    "MATIC/USDT","ROSE/USDT","CFX/USDT","EGLD/USDT","STX/USDT",
    "DYDX/USDT","SKL/USDT","PENDLE/USDT","AR/USDT","AXS/USDT","SUI/USTD
]
_seen = set()
